    ...
    return (
        <Container>
            <Row>
                ...
                <Col xs={12} md={12} lg={6} className='d-flex align-items-center' style={{minHeight: '100vh'}}>
                    <SimpleCard >
                        <Form onSubmit={formik.handleSubmit}>
                            ...
                            <FormGroup>
                                ...
                                <Input type="email" invalid={formik.errors.correo?true:false} onChange={formik.handleChange} name="correo" id="exampleEmail" placeholder="usuario@email.com" />
                            </FormGroup>
                            <FormGroup>
                                <Label for="examplePassword">Password</Label>
                                <Input  type="password" invalid={formik.errors.password?true:false} onChange={formik.handleChange} name="password" id="examplePassword" placeholder="Contraseña" />
                            </FormGroup>
                            <div className="d-flex justify-content-between align-items-center">
                                <PrimaryBtn disabled={loading} type='submit' >Ingresar</PrimaryBtn>
                                <SecondaryBtn   disabled={loading}  type='button' onClick={singIn} >Registrase</SecondaryBtn>
                            </div>
